...
import app.mbl.hcmute.chatApp.domain.entities.createLocalMessage
    ...
    private fun takePhoto() {
        ...
        val contentValues = ContentValues().apply {
            ...
            if (Build.VERSION.SDK_INT > Build.VERSION_CODES.P) {
                put(MediaStore.Images.Media.RELATIVE_PATH, "Pictures/Chat-Assistant")
            }
        }
            ...
            object : ImageCapture.OnImageSavedCallback {
                ...
                override fun
                    ...
                    navigator.navigateTo(
                        ScanFragmentDirections.actionScanFragmentToCropperFragment()
                    )
                }
            }
        )
